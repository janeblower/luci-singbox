...
install -m 0755 "$PKG_SRC/root/usr/share/singbox-ui/fetch_subscriptions.sh"  "$APP_ROOT/usr/share/singbox-ui/fetch_subscriptions.sh"
install -m 0755 "$PKG_SRC/root/usr/share/singbox-ui/fetch_rulesets.sh"       "$APP_ROOT/usr/share/singbox-ui/fetch_rulesets.sh"
install -m 0755 "$PKG_SRC/root/usr/share/singbox-ui/refresh.sh"              "$APP_ROOT/usr/share/singbox-ui/refresh.sh"
