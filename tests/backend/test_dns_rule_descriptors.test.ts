...
describe("test_dns_rule_descriptors", () => {
  useGuest();

  it("dns_rule descriptors: default/logical registered and filler builds correct output; headless drops action/exclusive fields", async () => {
    const src = `
