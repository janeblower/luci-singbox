// 40-save-roundtrip.spec.ts — seed a VLESS outbound through UCI (simulating
...
import { test, assert, containerExec } from './fixtures';

const SID = '_e2bt_save';

test('save-roundtrip: seed VLESS outbound and apply', async () => {
